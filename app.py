...
if uploaded_file is not None:
    # ✅ Fix for Streamlit Cloud: decode uploaded file properly
    ...
    ax1.text(0, 0, f"{fraud_pct*100:.1f}%\nFraud", ha="center", va="center", fontsize=18, fontweight="bold", color="crimson")
    ax1.legend(wedges, ["Fraud", "Legit"], title="Class", loc="center left", bbox_to_anchor=(1, 0, 0.5, 1))
    ax1.axis("equal")
    plt.tight_layout()
    st.pyplot(fig1)
